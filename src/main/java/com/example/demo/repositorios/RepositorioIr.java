...
@Repository
public interface RepositorioIr extends CrudRepository<VerboIr, String>{
    ...
    @Query
    (value = "SELECT primera_personas FROM verbo_ir WHERE verbo_infinitivo = ?1", nativeQuery = true)
    String findPrimeraPersonaSByVerboInfinitivo(String verboInfinitivo);

    @Query
    (value = "SELECT segunda_personas FROM verbo_ir WHERE verbo_infinitivo = ?1", nativeQuery = true)
    String findPrimeraSegundaSByVerboInfinitivo(String verboInfinitivo);

    @Query
    (value = "SELECT tercera_personas FROM verbo_ir WHERE verbo_infinitivo = ?1", nativeQuery = true)
    String findPrimeraTerceraSByVerboInfinitivo(String verboInfinitivo);

    @Query
    (value = "SELECT primera_personap FROM verbo_ir WHERE verbo_infinitivo = ?1", nativeQuery = true)
    String findPrimeraPersonaPByVerboInfinitivo(String verboInfinitivo);

    @Query
    (value = "SELECT segunda_personap FROM verbo_ir WHERE verbo_infinitivo = ?1", nativeQuery = true)
    String findPrimeraSegundaPByVerboInfinitivo(String verboInfinitivo);

    @Query
    (value = "SELECT tercera_personap FROM verbo_ir WHERE verbo_infinitivo = ?1", nativeQuery = true)
